...
class URI
{
    ...
    public function setURI(?string $uri = null)
    {
        if ($uri !== null) {
            ...
            if ($parts === false) {
                ...
                throw new RuntimeException(__('HTTP.cannotParseURI', [$uri]));
            }
    ...
    public function getSegment(int $number, string $default = ''): string
    {
        ...
        if ($number > count($this->segments) && !$this->silent) {
            throw new RuntimeException(__('HTTP.segmentOutOfRange', [$number]));
        }
    ...
    public function setPort(?int $port = null)
    {
        ...
        if ($port <= 0 || $port > 65535) {
            ...
            throw new RuntimeException(__('HTTP.invalidPort', [$port]));
        }
    ...
    public function setQuery(string $query)
    {
        if (strpos($query, '#') !== false) {
            ...
            throw new RuntimeException(__('HTTP.malformedQueryString'));
        }
