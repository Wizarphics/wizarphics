 ...
 * Date Created: 11/18/22, 01:24 PM
 * Last Modified at: 11/18/22, 01:24 PM
 * Time: 1:24 PM
    ...
    public function getFile(string $name)
    {
        ...
        if ($this->hasFile($name)) {
            if (strpos($name, '.') !== false) {
                ...
                return $uploadedFile instanceof FileUploaded ? $uploadedFile : null;
            }
    ...
    public function getFileMultiple(string $name)
    {
        ...
        if ($this->hasFile($name)) {
            if (strpos($name, '.') !== false) {
                ...
                return (is_array($uploadedFile) && ($uploadedFile[array_key_first($uploadedFile)] instanceof FileUploaded)) ?
                    $uploadedFile : null;
            }
