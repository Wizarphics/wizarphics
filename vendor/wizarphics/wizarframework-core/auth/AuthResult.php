...
class AuthResult
{
     ...
     * Extra information.
     *
     * @var string|UserModel|null `User` when successful. Suggestion strings when fails.
     */
    protected $extraInfo;
    ...
    /**
     * @return string|UserModel|User|null `User` when successful. Suggestion strings when fails.
     */
